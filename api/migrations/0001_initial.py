# Generated by Django 5.0 on 2023-12-30 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feeling', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.workoutfeeling')),
                ('training_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.workoutitem')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.workoutsession')),
            ],
            options={
                'verbose_name': 'ワークアウト',
                'ordering': ['-trained_at'],
